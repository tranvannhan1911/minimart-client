pipeline {
    ...
    environment {
        GIT_REPOSITORY = "git@github.com:tranvannhan1911/minimart-client.git"
        DOCKER_REPOSITORY = "tranvannhan1911/minimart-client"
        CONTAINER_NAME = "minimart-client"
            ...
            steps {
                script{
                    checkout([$class: 'GitSCM', 
                        ...
                        userRemoteConfigs: [[url: GIT_REPOSITORY, credentialsId: "git-minimart-client"]]])
                }
            }
        }
