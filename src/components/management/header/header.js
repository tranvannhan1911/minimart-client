  ...
  return (
    <PageHeader
      ...
      extra={[
        ...
        <Typography.Text style={{ marginRight: '10px' }}>Chào {time} {name ? <Typography.Title level={5} style={{ display: 'inline-block' }}> {name}</Typography.Title> : ""}, {welcome} </Typography.Text>,
